export class SDates {
    ...
    constructor(day = null, month = null, year = null){
        ...
        if (this.#parametersOK(this.#day, this.#month, this.#year, "SDates()") !== true) {
            this.#year = null;
            this.#month = null;
            this.#day = null;
        }
    ...
    #parametersOK(_day, _month, _year, callerSTR) {
        ...
        if (Number.isInteger(_year) === false
        || Number.isInteger(_month) === false
        || Number.isInteger(_day) === false
        //|| _year < 1
        || _month < 1
        || _day < 1) {
            console.warn(`${callerSTR} ERROR: day/month/year must be an Integer.\n day/month values cannot be under 1.`);
            return false;
        }

        // Revisa que el mes y día no estén por arriba del máximo
        if (_month > 12) { console.warn(`${callerSTR} ERROR: month value cannot be above 12.`); return false; }
        if (_day > this.#amountOfDaysOfMonth(_month, _year)) {
            console.warn(`${callerSTR} ERROR: day value above maximum for this month (${_month}/${_year}).`);
            return false;
        }        
    ...
    #isLeapYear(year){
        ...
        if (this.#esDivisible(year, 4) === false) { return false; }
        else if (this.#esDivisible(year, 100) === false) { return true; }
        else if (this.#esDivisible(year, 400) === true) { return true; }
        else { return false; }
    }
    ...
    #amountOfDaysOfMonth(month, year = null){
        if (year === null){
            ...
            if (month === 2 && this.#isLeapYear(year) === true) { return 29; }
            else { return SDates.#monthsAOD[month - 1]; }
        }
    }

    #esDivisible(numero, divisiblePor){
        if(numero % divisiblePor === 0 || numero % divisiblePor === -0){ return true; }
        else {return false; } 
    }    

    #checkFebDayForLeapYear() {
        if (this.#isLeapYear(this.#year) === false && this.#month === 2 && this.#day === 29){ this.#day = 28; }
    }
    ...
    #checkMonthForAmountOfDays(){
        ...
        if (this.#day > diasDeEsteMes) { this.#day = diasDeEsteMes; }
    }
     ...
     */
       setDay(day) {
        ...
        if (this.#day === null || this.#month === null || this.#year === null) {
            console.warn("SDates() --> setDay(day) ERROR: day/month/year is null. Use setDate().");
            return;
        }

        if (Number.isInteger(day) === false
        || day < 1) {
            console.warn("SDates() --> setDay(day) ERROR: day must be an Integer, and the value cannot be under 1.");
            return;
        }

        if (day > this.#amountOfDaysOfMonth(this.#month, this.#year)) {
            console.warn(`SDates() --> setDay(day) ERROR: day value above maximum for this month (${this.#month}/${this.#year}).`);
            return;
        }
    ...
    setMonth(month) {
        ...
        if (this.#day === null || this.#month === null || this.#year === null) {
            console.warn("SDates() --> setMonth(month) ERROR: day/month/year is null. Use setDate().");
            return;
        }

        if (Number.isInteger(month) === false
        || month < 1) {
            console.warn("SDates() --> setMonth(month) ERROR: month must be an Integer, and the value cannot be under 1.");
            return;
        }

        if (this.#month > 12) {
            console.warn("SDates() --> setMonth(month) ERROR: month value cannot be above 12.");
            return;
        }

        if (this.#day > this.#amountOfDaysOfMonth(month, this.#year)){
            console.warn("SDates() --> setMonth(month) ERROR: month value is not compatible with current day/year.");
            return;
        }
    ...
    setYear(year) {
        ...
        if (this.#day === null || this.#month === null || this.#year === null) {
            console.warn("SDates() --> setYear(year) ERROR: day/month/year is null. Use setDate().");
            return;
        }

        if (Number.isInteger(year) === false) {
        //|| year < 1) {
            console.warn("SDates() --> setYear(year) ERROR: year must be an Integer.");
            return;
        }

        if (this.#day > this.#amountOfDaysOfMonth(this.#month, year)){
            console.warn("SDates() --> setYear(year) ERROR: year value is not compatible with current day/month.");
            return;
        }
    ...
    setDate(day, month, year) {
        ...
        if (day === null || month === null || year === null) {
            console.warn("SDates() --> setDate(day, month, year) ERROR: day/month/year cannot be null.");
            return;
        }

        if (this.#parametersOK(day, month, year, `SDates.setDate(${day}, ${month}, ${year})`) === true) {
            this.#day = day;
            this.#month = month;
            this.#year = year;
        }
     ...
     */
      addYear(years) {
        ...
        if (this.#day === null || this.#month === null || this.#year === null) {
            console.warn("SDates() --> addYear(years) ERROR: day/month/year is null. Use setDate().");
            return;
        }
    ...
    addMonth(months) {
        ...
        // Controla el parámetro
        if (this.#day === null || this.#month === null || this.#year === null) {
            console.warn("SDates() --> addMonth(months) ERROR: day/month/year is null. Use setDate().");
            return;
        }
    ...
    /**
     * Add the number of days to pass as a parameter.
    ...
    addDay(days) {
        ...
        // Controla el parámetro
        if (this.#day === null || this.#month === null || this.#year === null) {
            console.warn("SDates() --> addDay(days) ERROR: day/month/year is null. Use setDate().");
            return;
        }
    ...
    subtractYear(years) {
        ...
        // Controla el parámetro
        if (this.#day === null || this.#month === null || this.#year === null) {
            console.warn("SDates() --> subtractYear(years) ERROR: day/month/year is null. Use setDate().");
            return;
        }
    ...
    subtractMonth(months) {
        ...
        // Controla el parámetro
        if (this.#day === null || this.#month === null || this.#year === null) {
            console.warn("SDates() --> subtractMonth(months) ERROR: day/month/year is null. Use setDate().");
            return;
        }
        ...
        if (months < 1) { 
            console.warn(`SDates.subtractMonth(${months}): months cannot be under 1.`)
            return;
        }

        if (Number.isInteger(months) === false) { 
            console.warn(`SDates.subtractMonth(${months}): months must be an integer.`)
            return;
        }
    ...
    subtractDay(days){
        ...
        // Controla el parámetro
        if (this.#day === null || this.#month === null || this.#year === null) {
            console.warn("SDates() --> subtractDay(days) ERROR: day/month/year is null. Use setDate().");
            return;
        }
    ...
    isGreaterThan(anotherDate = new SDates()) {
        ...
        if (anotherDate instanceof SDates === false) {
            console.warn(`SDates.isGreaterThan(${anotherDate}) --> ERROR: *anotherDate* must be an instance of SDates`);
            return;
        }

        if (anotherDate.getDay() === null || anotherDate.getMonth() === null || anotherDate.getYear() === null) {
            console.warn(`SDates.isGreaterThan(${anotherDate}) --> ERROR: *anotherDate* day/month/year cannot have null values.`);
            return;
        }

        if (this.#day === null || this.#month === null || this.#year === null) {
            console.warn('SDates.isGreaterThan() --> ERROR: day/month/year cannot have null values.');
            return;
        }

        if (this.#year > anotherDate.getYear()) {return true}
        if (this.#year < anotherDate.getYear()) {return false}
        if (this.#month > anotherDate.getMonth()) {return true}
        if (this.#month < anotherDate.getMonth()) {return false}
        if (this.#day > anotherDate.getDay()) {return true}
        else {return false}
    } // isGreaterThan()
    ...
    isEqualTo(anotherDate = new SDates()) {
        ...
        if (this.#year === anotherDate.getYear()
         ...
         && this.#day === anotherDate.getDay()) { return true; }
        else { return false; }
    ...
    isEqualOrGreaterThan(anotherDate = new SDates()) {
        ...
        if (this.isEqualTo(anotherDate) === true) { return true; }
        if (this.isGreaterThan(anotherDate) === true) { return true; }
        else { return false; }
    ...
    isLowerThan(anotherDate = new SDates()) {
        ...
        if (this.isEqualOrGreaterThan(anotherDate) === false) { return true; }
        else { return false; }
    }
    ...
    isEqualOrLowerThan(anotherDate = new SDates()) {
        ...
        if (this.isEqualTo(anotherDate) === true) { return true; }
        if (this.isLowerThan(anotherDate) === true) { return true; }
        else { return false; }
    }
     ...
     */
    isNull() {
        if (this.#day === null || this.#month === null || this.#year === null) { return true; }
        else { return false; }
    }
